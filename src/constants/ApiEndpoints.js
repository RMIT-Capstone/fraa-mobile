...
export const VERIFY_IDENTITY_API = '68.183.239.207/cv_verify';
...
export const ATTENDANCE_STATS_WITH_GROUPING =
  'https://asia-northeast1-fraa-capstone.cloudfunctions.net/api/count_missed_total_attendance_sessions_by_courses_group';
...
export const REGISTER_ATTENDANCE =
...
export const GET_COURSES_BY_CODES = 'https://asia-northeast1-fraa-capstone.cloudfunctions.net/api/get_courses_by_codes';
