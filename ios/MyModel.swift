...
//      outputTensor.data.copyBytes(to: outputData)
      if(interpreter != nil) {
          EventEmitter.sharedInstance.dispatch(name: "BackgroundLoadTask", body:["status":"load interpreter: success (not null)"])
      ...
      // Error handling...
        EventEmitter.sharedInstance.dispatch(name: "BackgroundLoadTask", body:["status":"error..."])
